...
public class CategoryController {
    ...
    @Operation(
            ...
            tags = {"Category"},
            parameters = {
                    @Parameter(name = "id", description = "UUID de la categoria", example = "11111111-2222-3333-4444-555555555555")
            },
            responses = {
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(responseCode = "200", description = "Categoria creada", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Category.class)))
            }
    )
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(responseCode = "200", description = "Categoria actualizada", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Category.class))),
                    @ApiResponse(responseCode = "404", description = "Categoria no encontrada")
            }
    )
    public Category updateCategory(@PathVariable UUID id, @RequestBody CategoryUpsertRequest request) {
        Category category = new Category();
        category.setName(request.getName());
        category.setType(request.getType());
        category.setDescription(request.getDescription());
